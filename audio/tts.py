"""
audio/tts.py — convert a podcast script to MP3 segments using Edge TTS.
...
synthesise_script() loops all turns sequentially and returns the ordered list
of paths for the assembler to stitch.
"""
...
# ── Voice reference ────────────────────────────────────────────────────────────
# Swap HOST_A_VOICE / HOST_B_VOICE in .env to change voices.
#
# British male                British female
# ─────────────────────────── ──────────────────────────────
# en-GB-ThomasNeural  ← default (natural, measured)
# en-GB-RyanNeural    (clear, slightly formal)
# en-GB-OliverNeural  (warm, conversational)
#
#                             en-GB-LibbyNeural   ← default (warm, expressive)
...
async def synthesise_turn(text: str, voice: str, output_path: str) -> str:
    ...
    Args:
        text        : The spoken line (plain text, no SSML needed).
        voice       : Edge TTS voice identifier, e.g. "en-GB-ThomasNeural".
